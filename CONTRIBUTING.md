# Contributing to stapel-profiles
...
```bash
git clone https://github.com/usestapel/stapel-profiles.git && cd stapel-profiles
...
The packages use a flat layout (`package-dir = {{"stapel_profiles": "."}}`), so the
